export const descriptions = [
    ...
    },
    {
        ...
        desc: "Spend your day out on the waters off of Honolulu on this bottom fishing adventure. Board your vessel setting off for nearshore and offshore grounds in search of prized fish.This tour is great for a group of friends or families who want to enjoy a day on the water without the hassle of chartering their own boat."
    },
    {
        activity: "Jurassic Valley Adventure Tour",
    ...
    },
    {
        ...
        desc: "Learn about World War II history on this guided group tour to Pearl Harbor, which includes round-trip transfers from  Waikīkī hotels.Visit the Pearl Harbor Visitor's Center and get to explore inside the USS Battleship Missouri and the USS Arizona Memorial Boat, where you learn about the war and get an idea of what life at sea was like during the war."
    },
    {
        activity: "Polynesian Cultural Center",
        desc: "Immerse yourself in the rich traditions of six Pacific Island cultures as you wander through authentic Island Villages while participating in exciting cultural presentations and fun hands- on activities.Enjoy the ALI’I LŪʻAU, featuring a traditional Hawaiian feast of kalua pork, and other island specialties.Enjoy the beauty of Hawaiian hula, live music, and a royal procession.Or choose the GATEWAY BUFFET: A fusion of Pacific and Asian flavors held in a grand hall lined with murals of a Hawaiian welcome.Experience the power of “Hā: Breath of Life,” an action - packed story of passion ignited by fire, song, and dance featuring over 100 Polynesian performers from across the Pacific."
    },
    {
        activity: "Waikīkī Snorkeling & Ocean Waterpark Adventure",
        desc: "Escape the crowds of Waikīkī Beach by setting sail along the coastline onboard a 55-foot (17-meter) catamaran. With Diamond Head as your backdrop, have fun with the 35-foot(11 - meter) ocean slide, inflatable jumping platform, and floating ocean mat, or jump off board to snorkel at a crowd- free reef where you may encounter sea turtles."
    }
]